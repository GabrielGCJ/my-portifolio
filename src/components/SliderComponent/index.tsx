      ...
      <Zoom>
        <SliderAndTextComponent>
          <SliderComponentContainer>
            ...
            >
              <SwiperSlide>
                <a href="https://gb-project-timer.surge.sh/" target="_blank">
                  <img
              ...
              <SwiperSlide>
                <a href="https://coffee-delivery.surge.sh/" target="_blank">
                  <img
              ...
              <SwiperSlide>
                <a href="https://gb-todo-list.surge.sh/" target="_blank">
                  <img
              ...
              <SwiperSlide>
                <a href="https://gb-ignite-feed.surge.sh/" target="_blank">
                  <img
